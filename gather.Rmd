...
Citation_Data <- SCDB_2020_01_justiceCentered_Citation %>% 
  ...
  mutate(justice_fullnames = case_when(justiceName == "HHBurton" ~ "Harold Hitz Burton",
                                       justiceName == "RHJackson" ~ "Harold Hitz Burton",
                                       justiceName == "WODouglas" ~ "Harold Hitz Burton",
                                       justiceName == "FFrankfurter" ~ "Harold Hitz Burton",
                                       justiceName == "SFReed" ~ "Harold Hitz Burton",
                                       justiceName == "HLBlack" ~ "Harold Hitz Burton",
                                       justiceName == "WBRutledge" ~ "Harold Hitz Burton",
                                       justiceName == "FMurphy" ~ "Harold Hitz Burton",
                                       justiceName == "FMVinson" ~ "Harold Hitz Burton",
                                       justiceName == "TCClark" ~ "Harold Hitz Burton",
                                       justiceName == "HHBurton" ~ "Harold Hitz Burton",
                                       justiceName == "HHBurton" ~ "Harold Hitz Burton",
                                       justiceName == "HHBurton" ~ "Harold Hitz Burton",
                                       justiceName == "HHBurton" ~ "Harold Hitz Burton",
                                       justiceName == "HHBurton" ~ "Harold Hitz Burton",
